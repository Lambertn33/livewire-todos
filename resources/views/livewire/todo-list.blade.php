<div wire:key='{{$todo->id}}'
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div>
            <input type="text" wire:model='editingTodoTitle' placeholder="Todo.."
        ...
        <div class="flex items-center gap-1">
            @if ($todo->completed)
            <input type="checkbox" checked wire:click='toggleTodo({{ $todo->id }})'>
            @else
    ...
    <span class="text-xs text-gray-500"> {{$todo->created_at->format('Y-m-d')}} </span>
